...
If the file is stored in a [private storage](github.com/tobento-ch/service-file-storage#private-storage), the Picture feature cannot generate a public preview image unless explicitly allowed.
...
This only enables the public preview image generated by the Picture feature.  
